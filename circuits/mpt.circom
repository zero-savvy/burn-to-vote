...
template IsSubarray(baseLen, subLen) {
...
// calculate the aggregated sum of sub array
    ...
    signal isValid[baseLen-subLen+1];
    ...
    isOne.in[0] <== isValid[baseLen-subLen];
    isOne.in[1] <== 1;
    exists <== isOne.out ;
